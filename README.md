...
These reports provide an analytical overview of various threat actors based on Open-Source Intelligence (OSINT), dark web intelligence sources, and publicly available reporting.
...
- **Section 1: Actor Background**  
  Known or assessed origin, affiliation, and attribution context.

- **Section 2: Targeting Patterns & Victimology**  
  Industries, regions, or entities commonly targeted, along with observed victim profiles.

- **Section 3: Tactics, Techniques, and Procedures (TTPs)**  
  Behavioral methodologies mapped where possible to frameworks such as MITRE ATT&CK.

- **Section 4: Indicators of Compromise (IOCs)**  
  Relevant technical artifacts such as domains, IP addresses, file hashes, and infrastructure indicators.
